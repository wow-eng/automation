...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field: 'jihua-id', width: 100, title: 'ID',fixed: 'left', sort: true}
      ,{field: 'jihua-sgs', title: '市公司',fixed: 'left', minWidth: 200}
      ,{field: 'jihua-xgs', width: 200,fixed: 'left',title: '县公司'}
  ...
  table.on('tool(LAY-app-content-list)', function(obj){
	...
	alert(data);
    if(obj.event === 'del'){
      layer.confirm('确定删除11此信息？', function(index){
        obj.del();
        layer.close(index);
      });
